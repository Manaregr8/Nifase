        ...
        <div className={styles.inner}>
          <div className={styles.top}>
            <div className={styles.leftColumn}>
              ...
              <div className={styles.mapBlock} aria-label="Company location">
                ...
                <div className={styles.mapAddress}>
                  Design, Savitri Cinema Complex, Block E, Greater Kailash II,
                  Greater Kailash, New Delhi, Delhi 110080
                </div>
              </div>
            </div>
            ...
            <div className={styles.emptyColumn}>
              ...
              <a href="tel:+911234567890" className={styles.phn}>
                +91 8743912102
              </a><br/>
              <a href="mailto:hello@example.com" className={styles.gmail}>
            	info@nifase.com
              </a>
            </div>
          </div>
